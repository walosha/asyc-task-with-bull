    ...
    moveToFinishedArgs(job, val, propVal, shouldRemove, target, token, timestamp, fetchNext = true) {
        ...
        const args = [
            ...
            pack({
                ...
                maxMetricsSize: ((_a = opts.metrics) === null || _a === void 0 ? void 0 : _a.maxDataPoints)
                    ? (_b = opts.metrics) === null || _b === void 0 ? void 0 : _b.maxDataPoints
                    : '',
                fpof: !!((_c = job.opts) === null || _c === void 0 ? void 0 : _c.failParentOnFailure),
            }),
        ];
        return keys.concat(args);
    }
